...
const ListingInfoFeature = () => {
  ...
  useEffect(() => {
    axios
      .get("http://localhost:4000/books/648e742cde6fde7dfc0f2e8e")
      .then((response) => {
    ...
    <div className={styles.featureWrapper}>
      <div className={styles.featureContainer}>
        <div className={styles.featureText}>
          ...
          <h2>
            <h2>
              {bookData.address && bookData.address.street}{" "}
              {bookData.address && bookData.address.suburb}{" "}
              {bookData.address && bookData.address.city}
            </h2>
          </h2>
          ...
          <span>
            Pets Allowed? <span className={styles.spanPets}>Yes</span>
          </span>

          <div className={styles.featuretteText}>
            <p>
              Welcome to this truly stunning villa nestled in the picturesque
              neighbourhood of Mount Eden.
              <br />
              <br />
              This gorgeous 5-bedroom property is a must-see, as it offers an
              exceptional blend of
              <br /> elegance, versatility, and prime location. With its
              irresistible charm, this home is sure to captivate your senses.
              <br />
              <br /> The raised ceilings and large windows throughout the villa
              allow natural sunlight to flood
